          ...
          <section className="lg:col-span-2">
            <div className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
              ...
              <form onSubmit={onSubmit} className="mt-4 grid gap-3">
                <Field label="Ton nom">
                  <input
                    className="w-full rounded-xl border border-zinc-200 bg-white px-3 py-2 outline-none placeholder:text-sm ring-0 placeholder:text-zinc-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-100"
                    value={form.name}
                ...
                <Field label="Tu ramènes quoi">
                  <input
                    className="w-full rounded-xl border border-zinc-200 bg-white px-3 py-2 outline-none placeholder:text-sm placeholder:text-zinc-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-100"
                    value={form.item}
